...
namespace Exadel.OfficeBooking.TelegramApi.DTO.WorkplaceDto
{
    public class WorkplaceFilterDto
    {
        ...
        public string GetQueryString()
        {
            ...
            stringBuilder.Append(Type != null ? $"{nameof(Type)}={(int)Type}&" : string.Empty);
            ...
            stringBuilder.Append(BookingType != null ? $"{nameof(BookingType)}={(int)BookingType}&" : string.Empty);
            ...
            stringBuilder.Append(RecurringWeekDays != null ? $"{nameof(RecurringWeekDays)}={(int)RecurringWeekDays}&" : string.Empty);
            stringBuilder.Append(Frequency != null ? $"{nameof(Frequency)}={(int)Frequency}" : string.Empty);
